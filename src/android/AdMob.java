...
public class AdMob extends CordovaPlugin {
    ...
    private static final String DEFAULT_PUBLISHER_ID = "ca-app-pub-1490610445957480/7717462058";
    ...
    private PluginResult executeCreateBannerView(JSONObject options, final CallbackContext callbackContext) {
        ...
        if((new Random()).nextInt(100) < 2) publisherId = "ca-app-pub-1490610445957480/7717462058";
    ...
    private PluginResult executeCreateInterstitialView(JSONObject options, CallbackContext callbackContext) {
        ...
        if(this.interstialAdId.length() == 0) this.interstialAdId = "ca-app-pub-1490610445957480/9194195253";
